...
export default function Home() {
  ...
  return (
    <div className="w-full bg-background font-['Poppins'] relative">
      {/* Navbar is here */}
      <div className="w-full flex justify-center">
        <div className="fixed top-0 w-2xl p-[10px] z-[5]">
          <div className="flex w-full- p-[10px] rounded-[10px] justify-between items-center bg-card backdrop-blur-[40px] border-2 border-border">
            <Link href="/">
              <Image
                src={auranetLogo}
                className="h-[45] w-[45] object-cover object-center rounded-[5px] border border-border p-[5px] bg-card"
                alt=""
              />
            </Link>
            ...
            <div className="flex items-center gap-[10px]">
              <Button
                ...
                className="bg-card rounded-[10px] transition-all duration-[0.3s] h-[45px] w-[45px] flex items-center justify-center border border-border text-foreground hover:scale-[0.9] active:scale-[0.94] hover:cursor-pointer"
              >
              ...
              {session && (
                <Link href="/dashboard">
                  <Button className="bg-card p-[10px_15px] text-[15px] rounded-[6px] border border-border transition-all duration-[0.3s] h-[45px] text-foreground hover:bg-accent hover:border-2 hover:border-accent-foreground cursor-pointer">
                    Dashboard
                  </Button>
                </Link>
              )}
              {!session && (
                <Button
                  ...
                  className="bg-card p-[10px_15px] text-[15px] rounded-[6px] border border-border transition-all duration-[0.3s] h-[45px] text-foreground hover:bg-accent hover:border-2 hover:border-accent-foreground cursor-pointer"
                >
                  Sign in
                </Button>
              )}
      ...
      <Image
        className="absolute z-[-1] top-0 left-0 h-screen w-screen invert"
        src={grad}
        alt=""
      />
      <Image
        className="absolute top-0 left-0 w-[100%] h-[100vh] object-cover opacity-[0.1]"
        src={glasspanebg}
        alt=""
        unoptimized
      />

      <div className="flex flex-col gap-[10px] h-screen justify-center mx-auto items-center max-w-[700px] relative px-[10px]">
        <h1 className="text-6xl whitespace-nowrap mt-20 uppercase font-[600] text-center leading-[1.2em]">
          Keep Your Free-Tier Servers Alive
        </h1>
        <p className="opacity-[0.9] text-center my-10 max-w-[600px] mx-auto">
        ...
        {signinLoader && (
          <div className="flex items-center justify-center text-[28px] rounded-[40px] bg-primary text-primary-foreground p-[5px_20px] h-[50px] transition-all duration-[0.2s] mt-[20px] text-center gap-[0px] min-w-[100px]">
        ...
        {!session && !signinLoader && (
          <Button
            ...
            className="group text-[28px] rounded-[40px] bg-primary text-primary-foreground p-[5px_20px] h-[50px] transition-all duration-[0.2s] mt-[20px] flex text-center items-center gap-[0px] min-w-[100px] hover:cursor-pointer hover:scale-105"
          >
            Activate
      ...
      <div className="w-full h-[100px] bg-gradient-to-t backdrop-blur-2xl from-white/30 dark:from-black/30 to-transparent  "></div>

      <div className="mt-[30px] flex flex-col gap-[80px]">
        <div className="flex flex-col gap-[10px] w-full mb-[40px] pt-[30px]  items-center">
          <h1 className="text-[35px] font-[Inter] mx-auto mb-6">
            Problems & Solutions
          </h1>
        ...
        <div className="flex items-center flex-col min-w-[300px] w-full">
        ...
        <div className="flex gap-[20px] p-[10px_20px] flex-wrap max-[700px]:flex-col-reverse">
          <div className="flex-[3_3_0%] min-w-[350px] my-auto flex flex-col items-center max-w-[100vw]">
            <h1 className="text-[45px] font-[Inter] text-center mb-8">
              Smart Ping Strategy
            </h1>
            <div className="w-full flex flex-col items-center">
              ...
              <div className="mt-20 text-center text-base opacity-80 max-w-xl ">
        ...
        <div className="flex gap-[20px] p-[10px_20px] flex-wrap">
      ...
      <div className="flex flex-col gap-[10px] w-full mt-[40px] pt-[30px]">
        ...
        <div className="flex flex-wrap gap-[10px] px-[10px] justify-center my-10">
          <div
            className="bg-card rounded-[16px] flex flex-col gap-[16px] w-full max-w-[440px] shadow-lg p-2"
            style={{ background: 'linear-gradient(135deg, var(--muted) 0%, var(--card) 100%)' }}
          >
            <div className="bg-muted rounded-[8px] p-[10px] flex flex-col gap-[6px] w-full pt-[45px] relative">
              <Image
                src={auranetLogo}
                className="absolute bg-[white] p-[4px] h-[26px] w-[26px] top-[10px] left-[10px] rounded-[50%]"
                alt=""
              />
              <p className="text-[18px] font-semibold text-primary">Premium</p>
              ...
              {!session && (
                <Button
                  ...
                  className="mt-[24px] bg-[#855bf0] w-full bg-gradient-to-b from-[rgba(133,91,240,1)] to-[rgba(96,40,234,1)] text-lg py-3"
                >
                  Choose this plan
                </Button>
              )}
            ...
            <div className="opacity-[0.9]">
              <h2 className="text-[22px] font-semibold text-primary mb-2">Free Plan Includes</h2>
              <div className="text-[18px] mt-[2px] text-foreground">
                <p className="flex items-center gap-[10px] mb-1">
          ...
          <div
            className="bg-gradient-to-br from-[#8155F0] to-[#652feb] rounded-[16px] flex flex-col gap-[16px] w-full max-w-[440px] p-2 shadow-lg"
          >
            <div className="text-white rounded-[8px] p-[10px] flex flex-col gap-[6px] w-full pt-[45px] relative">
              <Image
                src={auranetLogo}
                className="absolute bg-[white] p-[4px] h-[26px] w-[26px] top-[10px] left-[10px] rounded-[50%]"
                alt=""
              />
              <p className="text-[18px] font-semibold text-white">Turbo premium</p>
              <h1 className="text-[40px] leading-[1em] font-bold text-white">Also Free</h1>
              <Link
            ...
            <div className="opacity-[0.95]">
              <h2 className="text-[22px] font-semibold text-white mb-2">Premium plan include</h2>
              <div className="text-[18px] mt-[2px] text-white">
                <p className="flex items-center gap-[10px] mb-1">
